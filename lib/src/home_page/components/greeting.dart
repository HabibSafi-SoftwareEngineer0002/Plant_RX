        ...
        delegate: SliverChildBuilderDelegate((BuildContext context, index) {
          return Padding(
            ...
            child: Container(
              ...
              child: Padding(
                padding: EdgeInsets.fromLTRB((0.072 * height), 0, 0, (0.099 * height)),
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Text('Plant disease Identifier', style: TextStyle(fontFamily: 'SFBold', fontSize: 30, color: Colors.black))],
                ),
              ),
            ),
          );
